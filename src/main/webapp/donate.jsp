...
<body> 
  <div class="container"> 
    <div class="causes-details"> 
      ...
      <div class="cause"> 
        <img src="images/p1.jpg" alt="Feed a Homeless Person" class="cause-image"> 
        <h3>Give An Egg & Milk</h3> 
        <p>₹ 25 / Person</p> 
      </div> 
      <p> 
    ...
    <div class="donation-form"> 
      ...
      <form action="/submit-donation" method="POST"> 
        ...
        <input type="number" id="food-count" name="foodCount" value="20" required oninput="updateTotalAmount()"> 

        <label for="total-amount">Total Amount</label> 
        <input type="number" id="total-amount" name="totalAmount" value="500" required readonly> 
