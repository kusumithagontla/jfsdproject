...
<body> 
  <div class="container"> 
    <div class="causes-details"> 
      ...
      <div class="cause"> 
        <img src="images/p7.jpg" alt="Feed a Homeless Person" class="cause-image"> 
        <h3>Provide Medical Supplies for Rural Health Clinics</h3> 
        <p>₹ 5000 / Person</p> 
      </div> 
      <p> 
  ...
  <script>
    function updateTotalAmount() {
      ...
      var totalAmount = foodCount * 5000;
